...
END_MARK = '      </div>' + NL + '    </div>' + NL + NL + '    <!-- Sticky CTA Bar -->'

start_idx = content.find(START)
end_idx = content.find(END_MARK, start_idx)

if start_idx == -1 or end_idx == -1:
    print('ERROR: markers not found. start:', start_idx, 'end:', end_idx)
    exit(1)
...
NEW_GRID = (
    ...
    NL +
    '        <!-- ROW 0: Services Provided (left) | Trust & Safety (right) -->' + NL +
    ...
    '        </div>' + NL +
    NL +
    '        <!-- ROW 1: Certifications (left) | Industry Associations (right) -->' + NL +
    '        <div class="bento-card">' + NL +
    '          <div class="card-header">' + NL +
    '            <h2 class="card-title">' + NL +
    ...
    '        </div>' + NL +
    NL +
    '        <!-- ROW 2: Compliance (left) | Documentation (right) -->' + NL +
    '        <div class="bento-card" style="height: max-content;">' + NL +
    '          <div class="card-header">' + NL +
    '            <h2 class="card-title">' + NL +
...
print('Done! Final bento grid layout:')
print('  Row 0: Services Provided | Trust & Safety')
print('  Row 1: Certifications | Industry Associations')
print('  Row 2: Compliance | Documentation')
